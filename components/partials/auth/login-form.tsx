    ...
    <form onSubmit={handleSubmit(onSubmit)} className="mt-5 2xl:mt-7 space-y-4">
      ...
      <div className="mt-3.5 space-y-2">
        ...
        <div className="relative">
          <Input size="lg" disabled={isPending} {...register("password")} type={passwordType} id="password" className="peer  " placeholder=" " />
      ...
      <div className="flex justify-between">
        ...
        <Link href="/seller/auth/forgot-password" className="text-sm text-default-800 dark:text-default-400 leading-6 font-medium">
          Forgot Password?
        </Link>
      </div>
