 ...
 relative z-[1] bg-default-50"
        >
          <div className="max-w-[520px] pt-20 ps-20">
            ...
            <h4>
              Unlock your Project <span className="text-default-800  font-bold ms-2">performance</span>
            </h4>
          </div>
          ...
          <div className=" h-full flex flex-col">
            <div className="max-w-[524px] md:px-[42px] md:py-[44px] p-7  mx-auto w-full text-2xl text-default-900  mb-3 h-full flex flex-col justify-center">
              ...
              <div className="text-center 2xl:mb-10 mb-5">
                ...
                <div className="text-default-500  text-base">Create an account to start using Dashcode</div>
              </div>
              <RegForm />
              ...
              <div className="max-w-[225px] mx-auto font-normal text-default-500  2xl:mt-12 mt-6 uppercase text-sm">
                Already registered?
                <Link href="/seller/auth/login" className="text-default-900  font-medium hover:underline">
                  Sign In
                </Link>
              </div>
            </div>
