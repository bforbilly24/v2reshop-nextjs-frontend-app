        ...
        <div className="lg:col-span-9 col-span-12">
          <div className="md:flex mb-6 md:space-y-0 space-y-4">
            <div className="flex-1 flex  items-center gap-3">
              {menus?.map(({ href, active, icon }, index) => (
                <Button
                  ...
                  size="icon"
                  variant="outline"
                  className={cn("border border-default-400 text-default-400 hover:bg-transparent hover:text-default-400 h-11 w-11", { "text-default border-default hover:text-default hover:border-default": active })}
                >
                  <Link href={href}>
            ...
            <div className="flex-none sm:flex items-center gap-4 sm:space-y-0 space-y-2">
              ...
              <div className="flex gap-2 items-center">
                <Label htmlFor="select" className="text-sm font-normal whitespace-nowrap">
                  Sort by:
                </Label>
                <Select>
                  <SelectTrigger className="bg-transparent w-[110px] border-default-200 h-10">
