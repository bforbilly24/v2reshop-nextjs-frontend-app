...
const SectionBadge = ({ title }: Props) => {
  return (
    <div className='px-2.5 py-1 rounded-full bg-neutral-200 dark:bg-neutral-800 flex items-center justify-center gap-2'>
      ...
      <span className='text-xs font-medium text-transparent bg-clip-text bg-gradient-to-r from-primary to-emerald-400 dark:to-emerald-300'>
        {title}
      </span>
    </div>
  )
