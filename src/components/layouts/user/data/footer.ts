...
const FOOTER_GROUPS: FooterGroupItem[] = [
  {
    ...
    title: 'Quick Links',
    items: [
      { id: 'works-1', title: 'works', url: '/contact-us' },
      { id: 'affiliate-2', title: 'affiliate', url: '/contact-us' },
      { id: 'shop-3', title: 'shop', url: '/reproduct' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'career-3', title: 'career', url: '/about-us' },
      { id: 'blog-4', title: 'blog', url: '/recommunity' },
    ],
  },
  {
    id: 'help-center',
    title: 'help_center',
    items: [
      { id: 'faqs-1', title: 'faqs', url: '/contact-us' },
      { id: 'terms-2', title: 'terms_&_conditions', url: '/' },
      { id: 'privacy-3', title: 'privacy_policy', url: '/' },
      { id: 'help-4', title: 'help', url: '/contact-us' },
